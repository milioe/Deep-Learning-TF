# Deep Learning: Redes Neuronales con TensorFlow
...
| Convolucionales | [`Clasificación de Pizza y Sushi`](https://colab.research.google.com/drive/1LoeSSrRr8Fl7UxWKcch4yRgC0oSReSHj?usp=sharing), [`Clasificación de 10 comidas`](https://colab.research.google.com/drive/1lzShYnxY1Qusyyv9poBYh9oza7zoTnLN?usp=sharing), [`GradCam`](https://colab.research.google.com/drive/1vcIaaerI05s7pJBOO54hyXbKaIhJEyuL?usp=sharing) | [Convolucionales](https://github.com/milioe/Deep-Learning-TF/blob/main/Slides/Convolucionales.pdf) | [Hot Dogs & Tacos](https://colab.research.google.com/drive/1A3fVVhvcbWvIzjnkks3UiolkJkGr-1is?usp=sharing)| [`Pizza & sushi`](https://mendelbeer.com.mx/pizza_sushi.zip), [`Hotdog & Tacos`](https://mendelbeer.com.mx/hotdog_tacos.zip), [`10 food`](https://mendelbeer.com.mx/10_food_classes.zip), [`Paintings`]() |
| Transfer Learning | [`Feature Extraction`](), [`Fine Tunning`](), [`Scaling Up`](),  [`Clasificación de pinturas`](), [`Gradio: App`](), [`Style Transfer`]() | [Transfer Learning]() |[Asignación 4: 101 Food](), [Asignación 5: La mejor pintura]() | |
| Secuenciales | [`Clasificación de Tweets`](), [`Image Captioning`](), [`Precio de AAPL`](), [`Store Sales`]() | [Secuenciales]() | [Asignación 6: Sentimientos de Twitter]() |   [`Equipo 1: Financial Sentiment Analysis`](), [`Equipo 2: Amazon Reviews`](), [`Equipo 1: Precio de oro`](), [`Equipo 2: Pasajeros de aerolinea`]()| |
