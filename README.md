...
| Transfer Learning | [`Feature Extraction`](https://colab.research.google.com/drive/1lw4VHdXUMwcdNDicEJsQyli_7aXzc24N?usp=sharing), [`Fine Tunning`](https://colab.research.google.com/drive/1ZujcsfMxdBOeue21-cxM1I9VXb7O-rKh?usp=sharing), [`Asignación 4: 101 Food`](),  [`Clasificación de pinturas`](), [`Gradio: App`](), [`Style Transfer`]() | [Transfer Learning]() |[Asignación 4: La mejor pintura]() | |
| Secuenciales | [`Clasificación de Tweets`](), [`Image Captioning`](), [`Precio de AAPL`](), [`Store Sales`]() | [Secuenciales]() | [Asignación 5: Sentimientos de Twitter]() |   [`Equipo 1: Financial Sentiment Analysis`](), [`Equipo 2: Amazon Reviews`](), [`Equipo 1: Precio de oro`](), [`Equipo 2: Pasajeros de aerolinea`]()| |
| Proyecto final | [`Gravity AI`]() | [Ideas finales y cierre de curso]() | [Asignación 6: Proyecto final]() | |
