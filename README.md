...
|Unidad                     | Notebook FINAL | Slides | Data | Asignaciones | Competencias |
|---------------------------|----------------|--------|------| -------------|---------------|
...
| Regresión | [Regresión con TF]() | [Regresión](https://github.com/milioe/Deep-Learning-TF/blob/main/Slides/Regresion.pdf) | | | [`Equipo 1`](), [`Equipo 2`](), [`Equipo 3`](), [`Equipo 4`](), [`Equipo 5`]() 
